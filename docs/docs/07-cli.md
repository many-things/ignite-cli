...
```
  -h, --help                        help for network
      ...
      --spn-faucet-address string   set Ignite chain faucet address (default "https://faucet.devnet.ignite.com:443")
      --spn-node-address string     set Ignite chain RPC address (default "https://rpc.devnet.ignite.com:443")
```
